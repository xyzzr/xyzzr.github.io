...
if not getgenv().boboware or getgenv().boboware.Aimbot then return end
...
local Environment = getgenv().boboware.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().boboware.Aimbot.Functions = nil
	getgenv().boboware.Aimbot = nil
